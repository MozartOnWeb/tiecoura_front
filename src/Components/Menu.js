        ...
        <MenuWrapper>
          <MenuLinks>
            {serieName.slice(0, 1).map((link) => (
              <Button key={link.name} big="true" to={`/photos/${link.name}`}>
                Photos
                <svg
          ...
          <MenuDesc>
            <p>
              ...
              dicta temporibus alias explicabo aut autem commodi natus? Enim
              inventore, consectetur reprehenderit voluptas nihil laudantium hic
              sed distinctio, beatae quam excepturi?
            </p>
          </MenuDesc>
        </MenuWrapper>
        <MenuSocials>
